...
window = tk.Tk()
window.title("Students Attendance Management System using Face Recognition ")
    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='CHAN', user='root', password='', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Chandhine/semester 7/Mini project/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/Chandhine/semester 7/Mini project/Face-Recognition-Attendance-System-main/Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Chandhine/semester 7/Mini project/Face-Recognition-Attendance-System-main/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Chandhine\semester 7\Mini project\Face-Recognition-Attendance-System-main\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'Chan':
            if password == 'chan@653':
                ...
                cs = 'C:/Chandhine/semester 7/Mini project/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
